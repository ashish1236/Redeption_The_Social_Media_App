...
import com.menga.Redeption.databinding.UserspostsrvdesignBinding;
...
public class UserspostsAdapter extends RecyclerView.Adapter<UserspostsAdapter.viewHolder> {
    ...
    public UserspostsAdapter(ArrayList<PostModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.userspostsrvdesign,parent,false);
...
//        }
    ...
    public class viewHolder extends RecyclerView.ViewHolder{
        UserspostsrvdesignBinding binding;
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            binding=UserspostsrvdesignBinding.bind(itemView);
        }
    }
}
