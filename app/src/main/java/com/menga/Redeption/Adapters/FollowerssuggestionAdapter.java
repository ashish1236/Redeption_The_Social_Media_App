...
public class FollowerssuggestionAdapter extends RecyclerView.Adapter<FollowerssuggestionAdapter.viewHolder>{
ArrayList<Userdata>list;
Context context;

    public FollowerssuggestionAdapter(ArrayList<Userdata> list, Context context) {
        this.list = list;
...
///here code for following or follow buttun/////
        ...
        holder.binding.profilepohoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
