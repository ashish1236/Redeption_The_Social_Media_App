...
import com.menga.Redeption.databinding.UsersfollwingverticalBinding;
...
Context context;
    ...
    public usersfollowingadapter(ArrayList<FollowingModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.usersfollwingvertical,parent,false);
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        if (model.getFollowingto().equals(FirebaseAuth.getInstance().getUid())){
            holder.binding.followinbtn.setVisibility(View.GONE);
        }else {
            holder.binding.followinbtn.setVisibility(View.VISIBLE);
        }
    ...
    UsersfollwingverticalBinding binding;
    public viewHolder(@NonNull View itemView) {
        super(itemView);
        binding=UsersfollwingverticalBinding.bind(itemView);
    }
}
}
