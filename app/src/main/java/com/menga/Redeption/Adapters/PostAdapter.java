...
import com.menga.Redeption.databinding.DashbordRvSampleBinding;
...
//                        });
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        holder.binding.likes.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                FirebaseDatabase.getInstance().getReference().child("posts").child(model.getPostid()).child("likes").child(FirebaseAuth.getInstance().getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        holder.binding.likes.setTextColor(oldcolor);
            ...
            holder.binding.userprofile.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("usersid", model.getPostby());
                    context.startActivity(intent);
                }
            });
 ...
 /* holder.binding.save.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
      Saved_Posts_Model saved_posts_model=new Saved_Posts_Model();
        ...
        saved_posts_model.setSaved_by(FirebaseAuth.getInstance().getUid());
        saved_posts_model.setSaved_at(new Date().getTime());
        FirebaseDatabase.getInstance().getReference().child("Users").child("Saved_posts").setValue(saved_posts_model).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                holder.binding.save.setBackground(ContextCompat .getDrawable(context,R.drawable.save));
            }
        });
